...
const slides = [
  {
    ...
    subtitle:
      "This is your personal sanctuary for mindful living and daily reflection",
    gradient: ["#667eea", "#764ba2"],
    accentColor: "#8B5FBF",
  },
  {
    title: "Organize Mindfully",
    subtitle: "Transform chaos into clarity with gentle task management",
    emoji: "✨",
  ...
  },
  {
    ...
    subtitle: "Track your emotions, celebrate growth, and find inner peace",
    emoji: "🌱",
...
// Feno SVG Component
const FenoLogo = ({ size = 120, color = "#E41E5C" }) => (
...
export default function Swiper() {
          ...
          {index === slides.length - 1 && (
            ...
            >
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={styles.buttonText}>Jump right in</Text>
  ...
  // Dynamic accent color for particles
  const accentColor = scrollX.interpolate({
    inputRange: [0, width, width * 2],
    outputRange: [
      slides[0].accentColor,
      slides[1].accentColor,
      slides[2].accentColor,
    ],
    extrapolate: "clamp",
  });
  if (!fontsLoaded) {
